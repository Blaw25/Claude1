...
- **Calendar** — a month grid showing past and upcoming activity: variable expenses, paydays (income), investments, and recurring items, color-coded by type. Future recurring occurrences appear as projected (dashed) entries. Navigate months with ‹ / › / Today, and tap any day for a detailed breakdown with that day's net. On narrow screens, entries collapse into compact colored dots.
